...
source-domain \macrof{} change. \emph{Arm \macrof{} values are seeds mean-averaged
within patient; median unification of this secondary baseline is deferred
(\texttt{BLOCKERS.md}, ESC-4).}}
