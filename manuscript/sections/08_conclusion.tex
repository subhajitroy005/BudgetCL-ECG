...
per-patient \macrof{} from $0.666$ to $0.803$ and $0.809$, improve 17 of 21
patients (versus 12 of 21 for maximum head-only replay), and are both
significant against the frozen model (Holm $p\le0.008$) with large effect sizes.
...
still-non-significant direct comparison. We make no claim of microcontroller deployment; the budget is
analytical persistent state, and peak SRAM, latency, and energy are left to
future hardware-in-the-loop work.
