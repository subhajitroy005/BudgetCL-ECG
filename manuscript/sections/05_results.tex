...
Table~\ref{tab:pairwise_tests}) and improve 17 of 21 patients, against 12 of 21
...
improves more patients (17/21 vs 12/21), while its direct superiority over
maximum replay is neither established nor excluded at this sample size---not
``depth beats volume.'' The A4--A1 equivalence verdict is sensitive to record
232: dropping it moves the 90\% CI to $[0.000,0.020]$ and flips the verdict to
equivalent (Section~\ref{sec:protocol}); we report this rather than pick the
favourable cohort.
